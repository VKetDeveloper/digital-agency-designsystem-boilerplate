...
import type { NotificationBannerType_v2 } from '../types';

type IconProps_v2 = ComponentProps<'svg'>;

const InfoIcon = (props: IconProps_v2) => {
  const { ...rest } = props;
  return (
    <svg
      aria-label='情報提示'
...
const WarningIcon = (props: IconProps_v2) => {
  const { ...rest } = props;
  return (
    <svg
      aria-label='警告'
...
const ErrorIcon = (props: IconProps_v2) => {
  const { ...rest } = props;
  return (
    <svg
      aria-label='エラー'
...
const SuccessIcon = (props: IconProps_v2) => {
  const { ...rest } = props;
  return (
    <svg
      aria-label='成功'
...
type NotificationBannerIconProps_v2 = ComponentProps<'svg'> & {
  type: NotificationBannerType_v2;
};

export const NotificationBannerIcon = (props: NotificationBannerIconProps_v2) => {
